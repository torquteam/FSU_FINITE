...
int hybrd ( void fcn ( int n, double x[], double fvec[], int &iflag, double p[] ),
  ...
  double wa2[], double wa3[], double wa4[], double p[] )
...
//
    iflag = 2;
    fdjac1 ( fcn, n, x, fvec, fjac, ldfjac, iflag, ml, mu, epsfcn, wa1, wa2, p );
...
//
  ...
  info = hybrd ( fcn, n, x, fvec, xtol, maxfev, ml, mu, epsfcn, wa, mode,
    ...
    wa+n, wa+2*n, wa+3*n, wa+4*n, wa+5*n, p );
