...
void get_densities(double** meson_fields_unitless, int A, string energy_spectrum_neutron, string energy_spectrum_proton, double** &densities_svnp_unitless, int nrows_meson, int ncols_dens, double fw, double fp, int ncols_meson, double lgmr);
