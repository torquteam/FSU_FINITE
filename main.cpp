...
int main() {
    ...
    */
    ...
    // Experimental
    fin_couplings[0] = 1.14632905e+02; // gs2
    fin_couplings[1] = 1.92611766e+02; // gw2
    fin_couplings[2] = 8.61671721e+02; // gp2
    fin_couplings[3] = 0.0; // gd2
    fin_couplings[4] = 3.23100001e+00; // kappa
    fin_couplings[5] = -6.44591040e-03; // lambda
    fin_couplings[6] = 1.76276313e-02; // zeta
    fin_couplings[7] = 0.0; // xi
    fin_couplings[8] = 5.54070920e-02; // Lambda_v
    fin_couplings[9] = 0.0; // Lambda_s
    fin_couplings[10] = 0.0; // fw
    fin_couplings[11] = 0.0;    // fp
    fin_couplings[12] = 5.01269921e+02;
    ...
    */
    /*
    double BA, kf, p0, mstar, K, J_tilde, L, Ksym, zeta, xi, lambda_s, fw, fp,fc;
    double masses[4];
    // Experimental Model
    masses[0] = 4.91549991e+02;          
    masses[1] = 782.5; 
    masses[2] = 763.0; 
    masses[3] = 980.0;
    BA = -1.62575712e+01; //-16.23;                          // Binding energy (MeV) decreases binding proportionally (barely effects charge and skin)
    kf = 1.30651;                                    // larger values lower binding and (lower skin and charge radii equally)
    p0 = 1.49753382e-01; //2.0/(3.0*pow(pi,2.0))*pow(kf,3.0);        
    J_tilde = 3.49493244e+01;        // Symmetry energy at sat (MeV)
    mstar = 5.70818523e-01*939.0;      // Effective Mass (MeV)
    K = 2.30937605e+02;             // Compressibility (MeV) 
    L = 3.35064680e+01;               // Derivative of Symmetry Energy at sat (MeV)
    Ksym = 506.0;
    zeta = 2.94192165e-02;
    ...
    */
    ...
    hartree_method(fin_couplings,132,50,20,gridsize,3,Observables,1.2,true,true);
    ...
    */
    ...
    dm3.importdata("CRUSTEOS.txt",crust);
    int nrows = dm3.rowcount("CRUSTEOS.txt");
    ...
    */
    ...
    // RBM Methods
    //RBM_generate_fields(16,8,"param_sets_FSU.txt");
    //sample_param_space(50,"startfile_gold.txt");
    //get_Observables("param_sets_test_gold.txt",208,82);
    //get_Observables("param_sets_gar.txt",144,62);
